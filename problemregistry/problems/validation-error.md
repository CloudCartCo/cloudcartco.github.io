...
In addition, the Problem Details response may contain global extension fields; these are applicable to responses associated with any Problem Type in this registry and can be found at [https://cloudcartco/problemregistry/extensions](https://cloudcartco/problemregistry/extensions).

## Example Response

The following is a sample payload for this problem type, including the required `errors` object and the global `traceId` extension used for log correlation.
